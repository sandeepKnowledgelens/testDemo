...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Sandeep/testDemo'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Sandeep' => 'sandeep@knowledgelens.com' }
  s.source           = { :git => 'https://github.com/Sandeep/testDemo.git', :tag => s.version.to_s }
